...
public abstract class WorldController implements Screen {
	...
	/** Minimap asset */
	public static String MINIMAP_FILE = "minimaps/BETA_rooms.png"; // MINIMAP ASSET PATH PUT HERE!!!
	public static String JSON_FILE = "jsons/BETA_rooms.json"; // JSON ASSET PATH PUT HERE!!!
